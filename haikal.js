...
// Base © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 Hw Mods : Copyan Dari Base Dika

› Create By © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆
› Base Ori © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 */
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m })} 
//=================================================//
try {
...
let teks = `${q}`
for (let i of teks) {
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC © 𝙃𝙒 𝙈𝙊𝘿𝙎 𝙒𝘼`,"body": `Selamat ${salam} kak ${pushname}`,
...
{
"optionName": "SALAM BROTHER BY © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆"
}
],
...
break
//=================================================//
case 'kenztroli2': case 'kenztroli3': case 'kenztrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
case 'daca': case 'kenzdaca':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
case 'kenzdocu': case 'kenzdraknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'duc': case 'kenzslebew': case 'cumadocu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'kenzvirtext1': case 'kenzsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${iphone}` }, { quoted: doc })
}
}
break
case 'kenzvirtext2': case 'kenztol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${iphone1}` }, { quoted: doc })
}
}
break
case 'kenzzvirtext3': case 'kenzmemek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${iphone2}` }, { quoted: doc })
}
}
break
case 'kenzvirtext4': case 'kenzcontol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${iphone3}` }, { quoted: doc })
}
}
break
case 'kenzvirtext5': case 'kenztextv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${iphone4}` }, { quoted: doc })
}
}
break
case 'kenzvirtext6': case 'kenzgas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${iphone5}` }, { quoted: doc })
}
}
break
case 'kenzvirtext7': case 'kenzvirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${iphone6}` }, { quoted: doc })
}
}
break
case 'kenzvirtext8': case 'kenzvirtext1': case 'crashar7':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${buttonkal}` }, { quoted: doc })
}
}
break
case 'kenzvirtext9': case 'kenzvirtext2': case 'crashar8':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${buttonvirus}` }, { quoted: doc })
}
}
break
case 'kenzvirtext10': case 'kenzvirtext3': case 'crashar9': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
case 'kenzbug1': case 'kenzcrash': case 'crashar10':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'kenzbug2': case 'kenzcrash1': case 'crashar11': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"mimetype": "image/jpeg",
"caption": `© © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`,
...
break
//=================================================//
case 'kenzbug3': case 'kenzcrash2': case 'crashar12': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"fileName": `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`,
...
break
//=================================================//
case 'kenzbug4': case 'kenzcrash3': case 'crashar13':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"title": `© © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`,
"previewType": "NONE",
}
}), { userJid: m.chat, quoted: doc })
...
break
//=================================================//
case 'kenzbug5': case 'kenzcrash4': case 'crashar14': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case 'kenzbug6': case 'kenzcrash5': case 'crashar15':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'kenzbug7': case 'kenzcrash6': case 'crashar16':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"description": "Developer © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆\nWhatsApp / Script Bot \n\nORDER ? CHAT AJA 👋",
"title": `© © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
break
//=================================================//
case 'kenzbug8': case 'kenzcrash7': case 'crashar17': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`,
"groupName": `MY NAME © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`,
...
"title": `© © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`,
"description": `© © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆`,
"currencyCode": "IDR",
"footerText": `© © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆`,
"priceAmount1000": "10000000",
"productImageCount": 1,
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© © 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 WE ARE NOT MASTOD`,
...
break
case '🌷': case 'crashmek': case 'ampunsuhu': case 'ahyangbetul': case 'okemek': case 'banghwnih': case 'crashar18': case 'mexdemam': case 'kenzcrash1': case 'kenzcrash2': case 'kenzcrash3': case 'kenzcrash4': case 'kenzcrash5': case 'kenzcrash6': case 'kenzcrash7': case 'kenzcrash8': case 'kenzcrash9': case 'kenzcrash10': case 'kenzcrash11': case 'kenzcrash12': case 'kenzcrash13': case 'kenzcrash14': case 'kenzcrash15': case 'kenzcrash16': case 'kenzcrash17': case 'kenzcrash18': case 'kenzcrash19': case 'kenzcrash20': case '👽': case '☠': case '️👾': case '🪐': case '🦴': case '☝': case '🏻': case '🦖': case '🦕': case '👿': case '🐉': case '⚡': case '💥': case '🔥': case '🌪️': case '🍂': case '🍃': case '🌴': case '🌿': case '🍀': case '🪵': case '🦥': case '🌳': case '🍁': case '🎋': 
case '🦂':
case '🐍':
case '🍓':
case '🍒': 
...
user.afkReason = text
m.reply(`${m.pushName} Hello Saya Bot 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'kenzstik': case 'kenzkangbug': case 'buttonkematian': case 'crashar19': {
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
...
break
//=================================================//
case 'kenzbugie': case 'kenzkangbug1': case 'crashar20': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'kenzbutton': case 'kenzkangbuttton': case 'testbutton': case 'inibutton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${ngazap(prefix)}.BIN`, title: `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
//=================================================//
case 'kenztod': case 'kenzewe': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'kenzbokep': case 'kenzgentod': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, anuala, `© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
╰━━━╼⃟݊⃟̥⃝̇݊݊⃟ 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ݊⃟̥⃝̇݊⃟╾━━━╯
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆`, contextInfo:{"externalAdReply": {"title": `SC 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
╠➤𝐚𝐟𝐤 { 𝐤𝐚𝐬𝐢𝐡 𝐫𝐞𝐚𝐜𝐭𝐢𝐨𝐧𝐬 }
╠➤𝐤𝐞𝐧𝐳𝐠𝐡𝐨𝐢𝐛 [ 𝐨𝐧 / 𝐨𝐟𝐟 ]
╠➤𝐤𝐞𝐧𝐳𝐣𝐚𝐠𝐨𝐚𝐧 [ 𝐫𝐞𝐩𝐥𝐲 𝐭𝐚𝐫𝐠𝐞𝐭 ]
╠➤𝐤𝐞𝐧𝐳𝐬𝐚𝐧𝐠𝐞 [ 𝐇𝐚𝐫𝐮𝐬 𝐌𝐞𝐧𝐣𝐚𝐝𝐢 𝐀𝐝𝐦𝐢𝐧 ]
...
╠➤𝐜𝐫𝐚𝐬𝐡𝐦𝐞𝐱 𝟔𝟐𝟖𝐱𝐱𝐱|𝟓|𝟓
╠➤𝐤𝐞𝐧𝐳𝐬𝐤𝐮𝐲 𝟔𝟐𝟖𝐱𝐱𝐱
╠➤𝐤𝐞𝐧𝐳𝐬𝐚𝐧𝐭𝐞𝐭 𝟔𝟐𝟖𝐱𝐱𝐱@𝐬.𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩.𝐧𝐞𝐭|𝟏𝟎|𝟏𝟎𝐬
...
╔══════[ 𝐁𝐔𝐆 𝐆𝐑𝐎𝐔𝐏 ]══════⊱
╠➤𝐠𝐚𝐬𝐤𝐞𝐧𝐳 𝟏𝟏𝟐𝟔𝟕𝟒𝟒𝟒𝟖𝐱𝐱𝐱
╠➤𝐤𝐞𝐧𝐳𝐬𝐚𝐧𝐭𝐞𝐭𝐠𝐜  𝟏𝟐𝟑𝟕𝟖𝟗𝟏𝐱𝐱𝐱𝐱@𝐠.𝐮𝐬|𝟏𝟎|𝟏𝟎𝐬
...
╠➤𝐛𝐢𝐭𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐥𝐢𝐜𝐤 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐤𝐞𝐧𝐳𝐤𝐚𝐧𝐠𝐛𝐮𝐭𝐭𝐭𝐨𝐧 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐤𝐞𝐧𝐳𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝐝𝐞𝐥𝐚𝐲 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐤𝐞𝐧𝐳𝐬𝐭𝐢𝐤 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐤𝐞𝐧𝐳𝐛𝐮𝐠𝐢𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐛𝐮𝐠𝐥𝐨𝐤𝐚𝐬 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐤𝐞𝐧𝐳𝐭𝐨𝐝 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
...
╚════[ 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆 ]══════⊱`,
contextInfo:{"externalAdReply": {"title": `SC 𝑲𝒆𝒏 𝑬𝒙𝒄𝒖𝒕𝒆`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
...
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© © 𝑩𝑰𝑵𝒁 𝑩𝑶𝑻𝒁 𝙈𝙊𝘿𝙎 𝙒𝘼 WE ARE NOT MASTOD`,
"url": "Wa.me/6285714170944"
},
"businessOwnerJid": "6285714170944@s.whatsapp.net",
}
